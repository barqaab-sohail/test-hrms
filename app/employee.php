...
{
   protected $fillable = [
        'first_name','middle_name','last_name','father_name','date_of_birth','gender','cnic','cnic_expiry','employee_no','marital_status','religon','nationality','status','manager_id','department_id',
    ];
