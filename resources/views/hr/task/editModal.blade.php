                            ...
                            <div class="form-body">
                              <div class="form-group row">
                                <div class="col-md-12">
                                  <label class="control-label text-right">Task Detail<span class="text_requried">*</span></label>
                                   ...
                                   <input type="text" id='edit_task_detail' name="task_detail" value="{{ old('task_detail') }}" class="form-control notReadonly" placeholder="Enter Task Detail" required>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <div class="col-md-12 date_input">
                                  ...
                                  <input type="text" id="edit_completion_date" name="completion_date" value="{{ old('completion_date') }}" class="form-control notReadonly"  placeholder="Enter Task Completion Date" required readonly>
