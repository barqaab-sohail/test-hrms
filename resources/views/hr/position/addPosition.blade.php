				...
				<div class="row">
		        	...
		        	<div class="col-lg-10">
		                ...
		                <div class="card-body">
		                    ...
		                    <form action="{{route('storePosition')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
		                        {{csrf_field()}}
		                        <div class="form-body">
		                            ...
		                            <div class="row">
		                                <div class="col-md-9">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-9">
		                                            <input type="text"  name="name" value="" class="form-control" placeholder="Enter Position Name" required>
		                                        </div>
		                                    </div>
		                                </div>
