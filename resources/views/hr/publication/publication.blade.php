				...
				<div class="row">
		        	...
		        	<div class="col-lg-10">
		                ...
		                <div class="card-body">
		                    ...
		                    <form action="{{route('storePublication')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
		                        {{csrf_field()}}
		                        <div class="form-body">
		                            ...
		                            <div class="row">
		                                <div class="col-md-12">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-10">
		                                            <textarea type="text" rows=3 cols=20 name="description" class="form-control" placeholder="Enter Description" required>{{ old('description') }}</textarea>
		                                        </div>
		                                    </div>
		                                </div>
		                             ...
		                             <div class="row">
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-8">
		                                            <input type="text"  name="channel" value="{{ old('channel') }}" placeholder="Enter Publication Channel " class="form-control"  required>
		                                        </div>
