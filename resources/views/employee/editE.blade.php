		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-9">
		                                            <input type="text" name="middle_name" value="{{old('middle_name', $employee->middle_name) }}" class="form-control " placeholder="Enter Middle Name" required>
		                                        </div>
		                                    </div>
		                                </div>
		                                <!--/span-->
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-9">
		                                            <input type="email" name="email" value="{{ old('email', $employee->user->email) }}" class="form-control " placeholder="Enter Email" required>
		                                        </div>
		                                    </div>
		                                </div>
		                                <!--/span-->
		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-9">
		                                            <input type="text" name="cnic" value="{{old('cnic', $employee->cnic) }}" class="form-control " placeholder="Enter CNIC" required>
		                                        </div>
		                                    </div>
		                                </div>
		                                <div class="col-md-6">
