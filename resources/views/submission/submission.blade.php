		                                    ...
		                                    <div class="form-group row">
		                                        <div class="col-md-12 remove_div">
		                                        	...
		                                        	<select  name="total_marks"  class="form-control selectTwo">
		                                           	<option value=""></option>
		                                           	<option value="100" {{(old("evaluation_ratio")=="100"? "selected" : "")}}>100</option>
		                                           	<option value="1000" {{(old("evaluation_ratio")=="1000"? "selected" : "")}}>1000</option>
		                                    ...
		                                    <div class="form-group row">
		                                        <div class="col-md-12 remove_div">
		                                        	...
		                                        	<select  name="evaluation_ratio"  class="form-control selectTwo">
		                                           	<option value=""></option>
		                                           	<option value="80:20" {{(old("evaluation_ratio")=="80:20"? "selected" : "")}}>80:20</option>
		                                           	<option value="90:10" {{(old("evaluation_ratio")=="90:10"? "selected" : "")}}>90:10</option>
		                                           	<option value="70:30" {{(old("evaluation_ratio")=="70:30"? "selected" : "")}}>70:30</option>
		                                           	<option value="Least Cost" {{(old("evaluation_ratio")=="Least Cost"? "selected" : "")}}>Least Cost</option>
		                                           	</select>
