				...
				<div class="row">
		        	...
		        	<div class="col-lg-10">
		                ...
		                <div class="card-body">
		                    ...
		                    <form action="{{route('storeSalary')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
		                        {{csrf_field()}}
		                        <div class="form-body">
		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-3">
		                                            <input type="text" name="house_rent" value="{{ old('house_rent') }}"   class="form-control prc" required>
		                                        </div>
		                                    </div>
		                                </div>
		                                <!--/span-->
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-3">
		                                            <input type="number" name="dearness_allowance" value="{{ old('dearness_allowance') }}"   class="form-control prc"  required>
		                                        </div>
		                                         <label class="control-label text-right col-md-3">Adhoc 2009</label>
		                                        <div class="col-md-3">
		                                            <input type="number" name="adhoc_2009" value="{{ old('adhoc_2009') }}"   class="form-control prc" required>
		                             ...
		                             <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-3">
		                                            <input type="number" name="adhoc_2010" value="{{ old('adhoc_2010') }}"   class="form-control prc" required>
		                                        </div>
		                                         <label class="control-label text-right col-md-3">Adhoc 2012</label>
		                                        <div class="col-md-3">
		                                            <input type="text" name="adhoc_2012" value="{{ old('adhoc_2012') }}"   class="form-control prc" required>
		                                        </div>
		                                    </div>
		                                </div>
		                                <!--/span-->
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-3">
		                                            <input type="number" name="adhoc_2013" value="{{ old('adhoc_2013') }}"   class="form-control prc"  required>
		                                        </div>
		                                         <label class="control-label text-right col-md-3">Field Allowance</label>
		                                        <div class="col-md-3">
		                                            <input type="number" name="field_allowance" value="{{ old('field_allowance') }}"   class="form-control prc" required>
		                             ...
		                             <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-3">
		                                            <input type="number" name="other_allowance" value="{{ old('other_allowance') }}"   class="form-control prc" required>
		                                        </div>
