		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-10">
		                                            <input type="text" name="psotion" value="{{ old('psotion') }}" class="form-control " placeholder="Enter Position Name" required>
		                                        </div>
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-md-12">
		                                    <div class="form-group row">
		                                        ...
		                                        <div class="col-md-11">
		                                         <textarea  rows=10 cols=5 name="marks_obtain" value="{{ old('marks_obtain') }}" class="form-control " required></textarea>
		                                        </div>  
		                                    </div>
				...
				<table id="myTable" class="table table-bordered table-striped" width="100%" cellspacing="0">
					...
					<tbody>
						@foreach($experienceIds as $experienceId)
							<tr>
								<td>{{$experienceId->degree_name}}</td>
								<td>{{$experienceId->institute}}</td>
								<td>{{$experienceId->completion}}</td>
								<td>{{$experienceId->grade}}</td>
								<td>
								@if(Auth::user()->role_id==1)
								 <a class="btn btn-info btn-sm" href="{{route('education.edit',['id'=>$experienceId->id])}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fas fa-pencil-alt text-white "></i></a>
								 @endif
